...
import { HOME_ROUTE, ROOT_ROUTE, CHECKOUT_ROUTE, TRANSACTION_HISTORY_ROUTE, SESSION_COOKIE_NAME } from "./constants";

const protectedRoutes = [HOME_ROUTE, CHECKOUT_ROUTE, TRANSACTION_HISTORY_ROUTE];
